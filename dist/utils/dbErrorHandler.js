...
import { DatabaseError, UniqueConstraintError, NotFoundError, } from '../models/errors.js';
export function handleDbError(error, entity = 'Resource') {
    ...
    throw new DatabaseError(`Internal server error`, 'internal_server_error', error);
}
